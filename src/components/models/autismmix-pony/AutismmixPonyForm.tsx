...
import { useAutismmixPonyStore, MAX_LORAS } from '../../../store/models/autismmixPony.store'
...
export function AutismmixPonyForm({ model }: { model: ImageInferenceModelDefinition }) {
