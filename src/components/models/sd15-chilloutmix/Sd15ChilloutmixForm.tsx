...
import { useSd15ChilloutmixStore, MAX_LORAS } from '../../../store/models/sd15Chilloutmix.store'
...
export function Sd15ChilloutmixForm({ model }: { model: ImageInferenceModelDefinition }) {
